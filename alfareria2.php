...
<script type="text/javascript">
      function cargarProducto(a){
       ...
       /* #alfareria{
        ...
        .buscador-alfa:active{
         border:solid 0.5px #FF3300;
        }
        ...
        <div class="container">
          ...
          <ul class="site-menu js-clone-nav d-none d-md-block">
            ...
            <li class="has-children">
              <a href="alfareria1.php">Alfarer&iacuteas</a>
            </li>
            <li class="has-children">
...
<!--Buscar alfareria -->
<div class="alfareria-alfa">
  <h3>Seleccione una alfarer&iacutea</h3>


<select class="dropdown buscador-alfa"  onchange="cargarProducto(this)" name="alfareria_id_al" type="text" style="margin: 10px;   border-left:4px solid rgb(208,101,3, .7);
