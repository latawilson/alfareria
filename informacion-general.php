...
<body>
	...
	<p><a href="index_admin.html">Inicio </a> / <strong> Informacion general</strong></p>
	
			
	</div>
	<div class="contenedor-alfa2">
        ...
        <form action="" class="form_contact">
            ...
            <div class="user_info">
                <label for="names">Mision</label>
                <textarea id="mensaje"></textarea>

                <label for="phone">Vision</label>
                <textarea id="mensaje"></textarea>

                <label for="email">Historia</label>
                <textarea id="mensaje"></textarea>

                <label for="mensaje">Contactos</label>
                <textarea id="mensaje"></textarea>
