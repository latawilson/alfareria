...
<html lang="en">
  ...
  function cargarProvincia(opcion){
    var data;
    $.ajax({
      url: 'pro.php?id='+opcion.value,
      type: 'GET',
      data: data,         
...
<body >
 <div class="ventana">
   <div class="form">
    ...
    <div  id="divPro" class="site-section">
      <div   class="container">
        <div class="row">
          <div class="col-md-6">
            <img src="../images/tien1.jpg" alt="Image" class="img-fluid">
          </div>
          <div  class="col-md-6">         
            <hr> 
             <p align="justify">Tiene un dise&ntildeo antiguo donde se  utiliza frecuente mente como frutero.</p>
            <p>Su tama&ntildeo:30 x 40 cm</p>
            <p>Su peso:10 lb</p>
            <hr>
            <p class="mb-4"></p>
            <p><strong class="text-primary h4">$15.00</strong></p>
...
{
?>
              <div  id="alfareria"  name="pais" onchange="cargarProvincia(this)"class="col-sm-6 col-lg-4 mb-4" data-aos="fade-up" style="width: 10px;" >
       
      
                <div class="block-4 text-center border">
                  <figure class="block-4-image">
                    <a href="producto1.php"><img src="../imagen_pro/<?php echo($row['imagen_pro']); ?>" width="200px" height="100px"  alt="Image placeholder" class="img-fluid"  ></a>
                  </figure>
                  <div class="block-4-text p-4">
                    <h3><a href="producto1.php"><?php echo($row['nombre_pro']); ?></a></h3>
                    <p class="text-primary font-weight-bold">$<?php echo($row['precio_pro']); ?></p>
                    <p><a href="javascript:openVentana();"  value=" <?php echo($row['id_pro']); ?>"class="buy-now btn btn-sm btn-primary">Comprar</a></p>
                  </div>
