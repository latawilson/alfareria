...
<br>
    <div class="site-blocks-cover2 "style="background-image: url(images/dec2.jpg);" data-aos="fade">
      <div class="container">
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-7 col-lg-4">
              ...
              <div class="block-48-img">
                <div class="block-48-header">
                  <img src="images/de1.jpg" alt="Image placeholder" class="mb-4">
          ...
          <div class="col-md-7 col-lg-4">
              ...
              <div class="block-48-img">
                <div class="block-48-header">
                  <img src="images/de2.jpg" alt="Image placeholder" class="mb-4">
          ...
          <div class="col-md-7 col-lg-4">
              ...
              <div class="block-48-img">
                <div class="block-48-header">
                  <img src="images/de3.jpg" alt="Image placeholder" class="mb-4">
        ...
        <div class="row">
            ...
            <div class="row">
              ...
              <ul class="list-unstyled">
                <li class="address">E30 antes de la entrada al cant&oacuten Pujil&iacute 203 Fake St. Mountain View, San Francisco, California, USA</li>
                <li class="phone"><a href="tel://032224485">+3 222 448 5</a></li>
